...
public class PolynomialDriver {
    ...
    static public void main(String[] args) {
        ...
        ReferencePolynomial p = new ReferencePolynomial();
        System.out.print("p = ");
        showInfo(p);
        ...
        ReferencePolynomial q = new ReferencePolynomial();
        ...
        // Test case M.1
        System.out.println("\nTest case M.1:");
        ReferencePolynomial s = new ReferencePolynomial();
        ReferencePolynomial t = new ReferencePolynomial();
